  ...
  return (
    <div className="bg-slate-700">
      <div className="w-full xl:max-w-[1250px] mx-auto px-4 text-white">
        <div className="flex flex-col justify-center items-center flex-1 py-6 space-y-6 lg:space-y-8">
          <div className="font-bold text-xl lg:text-2xl">GET IN TOUCH</div>

          <div className="flex flex-col lg:flex-row justify-center items-center flex-1 gap-4">
          ...
          <div className="font-bold text-xl lg:text-2xl">FOLLOW US</div>
          ...
          <div className="w-4/5 h-[1px] bg-slate-300"></div>
          <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col lg:flex lg:justify-center">
            <p className="text-sm sm:ml-4 sm:pl-4 sm:py-2 sm:mt-0 mt-4">L.Dairy</p>
